...
# 可以改的参数,当前参数
args = 'key=147ECEC65F26088C6576EAB584C713235DE65E4C09649DC6770AF55F40D884B30E1EE2ED659CB89A96748A3E50C073F5_bingo,roleId=_bingo,strengthenKey=B50486D532775BE66354F99624D49545A81A5D76A6CFCA52AB929497249082211AEE9F0598093C195E663ABC66D997E9_bingo'

#os.environ 获取环境变量
ck =os.environ["JD_COOKIE"].split('&')
#split()：拆分字符串。通过指定分隔符对字符串进行切片，并返回分割后的字符串列表（list）
mycookies=[ck[0],ck[1],ck[3],ck[6],ck[10]]
#print(mycookies)
...
def qiang_quan(cookie, i, index):
    ...
    headers = {
        ...
        "Referer": "https://pro.m.jd.com/mall/active/2Tzd95wptFkN5hGchUxMSgjCVutV/index.html?cu=true&utm_source=kong&utm_medium=tuiguang&utm_campaign=t_51497_&utm_term=632a845809df48e4a72268d207799805",
        "Cookie": cookie,
        "User-Agent": Ua()
    }

    body = json.dumps({"activityId": "2Tzd95wptFkN5hGchUxMSgjCVutV",
                       "scene": "1",
                       "args": args,
                       "log": log_list[i]['log'],
